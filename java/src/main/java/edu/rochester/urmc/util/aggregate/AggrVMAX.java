...
public class AggrVMAX implements AggregateOnePass {
    ...
    public void process( HashMap record ) throws Exception{
        ...
        if( icare ){
            ...
            if( temp != null && temp.doubleValue() > currmax ){
                currmax = temp.doubleValue();
            }
        }
    }
    public Object result(){
        return currmax == Double.MIN_VALUE ? null :new Double( currmax );
    }
